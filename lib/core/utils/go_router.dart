...
import 'package:cinemax_app/core/utils/in_app_view.dart';
...
abstract class Approuter {
  ...
  static final GoRouter router = GoRouter(routes: [
    ...
    GoRoute(
      path: kWishListView,
      builder: (context, state) => WishListBlocProvider(),
    ),
    GoRoute(
      path: kYoutubePlayer,
    ...
    GoRoute(
      path: kCustomWebView,
      builder: (context, state) => CustomInappView(
        movieOrTvUrl: state.extra as String,
      ),
    ),
  ]);
}
