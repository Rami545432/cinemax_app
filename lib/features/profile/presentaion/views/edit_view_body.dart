...
import 'package:cinemax_app/features/profile/presentaion/widgets/edit_profile_list_view_componets.dart';
      ...
      child: BlocConsumer<FirebaseOpreationsCubit, FirebaseOpreationsState>(
        listener: (context, state) {
          if (state is FirebaseOpreationsSuccess) {
            ...
            showSnackBar(context,
                color: Colors.greenAccent, text: 'Your Data Has updated  !');
          }
        ...
        builder: (context, state) {
          return EditProfileListViewComponets(
              controllers: controllers, hintTexts: hintTexts);
        },
      ),
    );
  }
