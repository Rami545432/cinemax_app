...
import 'package:cinemax_app/features/seires/presentaion/widgets/tv_details_widgets/episode_loading_widgets/episode_card_loading.dart';
import 'package:flutter/material.dart';
import 'package:skeletonizer/skeletonizer.dart';

class EpisodeCardListViewBuilderLoading extends StatelessWidget {
  const EpisodeCardListViewBuilderLoading({
    super.key,
  });
